# 🛡️ Dimmy Energized AdBlock (Sing-box SRS)

Автоматизированная сборка правил для очистки трафика от рекламы, трекеров и обхода блокировок (DOH/VPN/Proxy). Сборка основана на элитных списках HaGeZi с персональными исключениями.
